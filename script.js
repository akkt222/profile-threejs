...
nameDiv.style.fontSize = 'clamp(2em, 5vw, 3em)';
...
titleDiv.style.fontSize = 'clamp(1em, 3vw, 1.5em)';
titleDiv.style.color = 'white';titleDiv.innerHTML = "Software Engineer<br><span style='font-size: clamp(0.8em, 2vw, 1em);'>Contact: <a href='mailto:akkt222@gmail.com' style='color: white; text-decoration: none;'>akkt222@gmail.com</a></span>";
...
aboutLink.style.fontSize = 'clamp(1em, 2vw, 1.2em)';
